  ...
  public: {
    Tables: {
      ...
      tenants: {
        Row: {
          id: number;
          members_email_regex: string | null;
          name: string;
          notes: string | null;
        };
        Insert: {
    ...
    Functions: {
      ...
      delete_claim: { Args: { claim: string; uid: string }; Returns: boolean };
      do_users_share_tenant: {
      ...
      is_role_in_tenant: {
        Args: { role_id: number; tenant_id: number };
        Returns: boolean;
      };
      is_timezone: { Args: { tz: string }; Returns: boolean };
      jwt_get_claim: { Args: { claim: string }; Returns: Json };
      jwt_has_permission: {
        Args: { perm: string; strict?: boolean };
        Returns: boolean;
      };
      jwt_is_expired: { Args: never; Returns: boolean };
      jwt_tenant_id: { Args: never; Returns: number };
      set_claim: {
